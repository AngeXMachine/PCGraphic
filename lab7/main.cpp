...
void Draw_Prism_With_Two_Different_Cross_Sections(float weight, float height, int storon, float x, float y, float z, float transparency) {
    ...
    while (!bQuit)
    {
        ...
        else
        {
            ...
            glPushMatrix(); //сохраняем текущую систему координат
                ...
                Draw_Prism_With_Two_Different_Cross_Sections(1,2,16,0,0,0,1);
                Draw_Prism_With_Two_Different_Cross_Sections(1,2,16,0,2,0,0.9);
                Draw_Prism_With_Two_Different_Cross_Sections(1,2,16,0,4,0,0.6);
                Draw_Prism_With_Two_Different_Cross_Sections(1,2,16,0,6,0,0.4);
                Draw_Prism_With_Two_Different_Cross_Sections(1,2,16,0,8,0,0.2);
                Draw_Prism_With_Two_Different_Cross_Sections(1,2,16,0,10,0,0.1);
