...
GLfloat light_position[] = { 0.0f, 0.0f, 3.0f, 0.0f}; //позиция источника света по осям xyz, последнее число не используется
...
void Init_Light()
{
     ...
     glLightfv(GL_LIGHT0, GL_POSITION, light_position); //позволяет использовать иустанавливать параметры источника света, в данном случае для нулевого источника цвета,
     // GL_POSITION означает, что мы хотим это сделать для нулевого источника света, в конце задаем саму позицию
