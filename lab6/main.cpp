        ...
        else
        {
            ...
            glPushMatrix(); //сохраняем текущую систему координат
                ...
                glPushMatrix();
                    ...
                    glRotatef(theta, 0.0, 1.0, 0.0); //поварачиваем всю СК вокруг оси y
                    on_light();// команды рисования из lighting.h
                    glTranslatef(0.0, 0.0, 1);		//начальный сдвиг системы координат
