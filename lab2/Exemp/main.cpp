...
void mEnu_init(){
    Menu_AddButton("Exemple", 50, 250, 100, 30, 2);
    ...
    Menu_AddButton("Quit", 50, 400, 150, 30, 2);
    Menu_AddButton("Next", 550, 350, 70, 30, 2);
    Menu_AddButton("Back", 250, 350, 70, 30, 2);
}
                   ...
                   int nCmdShow)
{
    ...
    Load_Texture( "godz.png", &bg, GL_REPEAT, GL_REPEAT, GL_NEAREST);
